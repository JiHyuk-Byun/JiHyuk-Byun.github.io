!(function (e, t) {
  ...
  function O(e) {
    ...
    if (n) {
      (L(n, t.querySelectorAll("h2, h3")),
        n.setAttribute("prerendered", "true"));
    }
  }
  // Copyright 2018 The Distill Template Authors
  function q(e) {
        ...
        function t() {
          ((this.months = [
            ...
            (this.key_equals_value = function () {
              var e = this.key();
              if (this.tryMatch("="))
                return (this.match("="), [e, this.value()]);
              throw (
              ...
              function (e, t) {
                ...
                ((f.mathord = function (e, t) {
                  var n = new o.default.MathNode("mi", [h(e.value, e.mode)]),
                    r = p(e, t) || "italic";
                  return (
                    r !== m[n.type] && n.setAttribute("mathvariant", r),
                    n
                  );
                }),
                  ...
                  (f.sizing = function (e, t) {
                    ...
                    return (
                      i.setAttribute("mathsize", n.sizeMultiplier + "em"),
                      i
                    );
                  }),
